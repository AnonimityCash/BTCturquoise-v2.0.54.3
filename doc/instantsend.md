...
This mechanism has been integrated into Bitcore-Node-BTCturquoise which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/btcturquoiseverse/insight-api-btcturquoise#web-socket-api](https://github.com/btcturquoiseverse/insight-api-btcturquoise#web-socket-api)
* API: [https://github.com/btcturquoiseverse/insight-api-btcturquoise#instantsend-transactions](https://github.com/btcturquoiseverse/insight-api-btcturquoise#instantsend-transactions)
