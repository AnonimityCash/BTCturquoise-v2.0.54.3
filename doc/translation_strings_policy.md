...
This document provides guidelines for internationalization of the BTCturquoise Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `btcturquoise_en.ts` remains unchanged.
