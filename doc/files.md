...
* btcturquoise.conf: contains configuration settings for btcturquoised or btcturquoise-qt
* btcturquoised.pid: stores the process id of btcturquoised while running
* database/*: BDB database environment; only used for wallet
* db.log: wallet database log file
* debug.log: contains debug information and general logging generated by btcturquoised or btcturquoise-qt
