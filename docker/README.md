...
official/supported Docker Images found at https://hub.docker.com/r/btcturquoise/btcturquoised/
...
**NOTE: Please update the image description at https://hub.docker.com/r/btcturquoise/btcturquoised-develop/ when changing the above text**