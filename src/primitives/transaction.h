...
#ifndef BTCTURQUOISE_PRIMITIVES_TRANSACTION_H
#define BTCTURQUOISE_PRIMITIVES_TRANSACTION_H
 ...
 * https://github.com/btcturquoise/bips/blob/master/bip-0069.mediawiki
 */
...
#endif // BTCTURQUOISE_PRIMITIVES_TRANSACTION_H
