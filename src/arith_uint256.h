...
#ifndef BTCturquoise_ARITH_UINT256_H
#define BTCturquoise_ARITH_UINT256_H
...
public:
     ...
     *
     * BTCturquoise only uses this "compact" format for encoding difficulty
...
#endif // BTCturquoise_ARITH_UINT256_H
