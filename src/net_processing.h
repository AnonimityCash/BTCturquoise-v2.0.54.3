...
#ifndef BTCTURQUOISE_NET_PROCESSING_H
#define BTCTURQUOISE_NET_PROCESSING_H
...
// Upstream moved this into net_processing.cpp (13417), however since we use Misbehaving in a number of btcturquoise specific
...
#endif // BTCTURQUOISE_NET_PROCESSING_H
