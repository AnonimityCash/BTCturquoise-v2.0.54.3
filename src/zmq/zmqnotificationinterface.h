// Copyright (c) 2015-2018 The BTCturquoise Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef BTCTURQUOISE_ZMQ_ZMQNOTIFICATIONINTERFACE_H
#define BTCTURQUOISE_ZMQ_ZMQNOTIFICATIONINTERFACE_H
...
#endif // BTCTURQUOISE_ZMQ_ZMQNOTIFICATIONINTERFACE_H
