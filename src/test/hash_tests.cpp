// Copyright (c) 2013-2015 The BTCturquoise Core developers
...
#define T(expected, seed, data) BOOST_CHECK_EQUAL(MurmurHash3(seed, ParseHex(data)), expected)
    ...
    // but is useful for those trying to implement BTCturquoise libraries as a
...
BOOST_AUTO_TEST_CASE(siphash)
{
    ...
    // TODO reenable when backporting BTCturquoise #10321
