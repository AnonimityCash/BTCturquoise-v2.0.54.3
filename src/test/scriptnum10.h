...
#ifndef BTCTURQUOISE_TEST_SCRIPTNUM10_H
#define BTCTURQUOISE_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from BTCturquoise Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // BTCTURQUOISE_TEST_BIGNUM_H
