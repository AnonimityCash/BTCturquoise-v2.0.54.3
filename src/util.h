 ...
 */
#ifndef BTCTURQUOISE_UTIL_H
#define BTCTURQUOISE_UTIL_H
...
//#define ENABLE_BTCturquoise_DEBUG
#ifdef ENABLE_BTCturquoise_DEBUG
#define DBG( x ) x
#else
#define DBG( x )
#endif
...
extern const char * const BTCTURQUOISE_CONF_FILENAME;
extern const char * const BTCTURQUOISE_PID_FILENAME;
...
{
    std::string s = "btcturquoise-" + name;
