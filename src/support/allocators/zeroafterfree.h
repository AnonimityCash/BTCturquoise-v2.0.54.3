...
#ifndef BTCTURQUOISE_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define BTCTURQUOISE_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // BTCTURQUOISE_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
