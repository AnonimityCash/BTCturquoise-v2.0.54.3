...
#ifndef BTCTURQUOISE_SUPPORT_ALLOCATORS_MT_POOLED_SECURE_H
#define BTCTURQUOISE_SUPPORT_ALLOCATORS_MT_POOLED_SECURE_H
...
#endif // BTCTURQUOISE_SUPPORT_ALLOCATORS_MT_POOLED_SECURE_H
