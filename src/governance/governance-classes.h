...
#ifndef BTCTURQUOISE_GOVERNANCE_GOVERNANCE_CLASSES_H
#define BTCTURQUOISE_GOVERNANCE_GOVERNANCE_CLASSES_H
...
#endif // BTCTURQUOISE_GOVERNANCE_GOVERNANCE_CLASSES_H
