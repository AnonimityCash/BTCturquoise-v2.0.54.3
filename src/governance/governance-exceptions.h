...
#ifndef BTCTURQUOISE_GOVERNANCE_GOVERNANCE_EXCEPTIONS_H
#define BTCTURQUOISE_GOVERNANCE_GOVERNANCE_EXCEPTIONS_H
...
#endif // BTCTURQUOISE_GOVERNANCE_GOVERNANCE_EXCEPTIONS_H
