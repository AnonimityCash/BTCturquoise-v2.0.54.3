...
#ifndef BTCTURQUOISE_GOVERNANCE_GOVERNANCE_VALIDATORS_H
#define BTCTURQUOISE_GOVERNANCE_GOVERNANCE_VALIDATORS_H
...
#endif // BTCTURQUOISE_GOVERNANCE_GOVERNANCE_VALIDATORS_H
