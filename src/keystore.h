...
#ifndef BTCTURQUOISE_KEYSTORE_H
#define BTCTURQUOISE_KEYSTORE_H
...
public:
    ...
    //! Support for BIP 0013 : see https://github.com/btcturquoise/bips/blob/master/bip-0013.mediawiki
