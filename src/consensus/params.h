...
#ifndef BTCTURQUOISE_CONSENSUS_PARAMS_H
#define BTCTURQUOISE_CONSENSUS_PARAMS_H
...
// See https://github.com/btcturquoiseverse/dips/blob/master/dip-0006.md for more details
struct LLMQParams {
    LLMQType type;
...
#endif // BTCTURQUOISE_CONSENSUS_PARAMS_H
