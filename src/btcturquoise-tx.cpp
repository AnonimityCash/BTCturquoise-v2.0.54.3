// Copyright (c) 2009-2018 The BTCturquoise Core developers
...
static void SetupBTCturquoiseTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf("%s btcturquoise-tx utility version", PACKAGE_NAME) + " " + FormatFullVersion() + "\n\n" +
            "Usage:\n"
              "  btcturquoise-tx [options] <hex-tx> [commands]  Update hex-encoded btcturquoise transaction\n" +
              "  btcturquoise-tx [options] -create [commands]   Create hex-encoded btcturquoise transaction\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded btcturquoise transaction
