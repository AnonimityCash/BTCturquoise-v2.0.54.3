...
#ifndef BTCTURQUOISE_COINJOIN_COINJOIN_CLIENT_OPTIONS_H
#define BTCTURQUOISE_COINJOIN_COINJOIN_CLIENT_OPTIONS_H
...
// create denominations for over 3000 btcturquoise!
...
#endif // BTCTURQUOISE_COINJOIN_COINJOIN_CLIENT_OPTIONS_H
