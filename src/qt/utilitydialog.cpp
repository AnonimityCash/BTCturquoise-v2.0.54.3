    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = "Usage:\n"
            "  btcturquoise-qt [command-line options]                     \n";
...
All the BTCturquoise in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.001 BTCQ, 0.01 BTCQ, 0.1 BTCQ, 1 BTCQ and 10 BTCQ -- sort of like the paper money you use every day.</li> \
...
QWidget *ShutdownWindow::showShutdownWindow(interfaces::Node& node, BTCturquoiseGUI *window)
{
    if (!window)
        return nullptr;
