    ...
    if(role == Qt::DisplayRole || role == Qt::EditRole)
    {
        ...
        case Amount:
            if (rec->recipient.amount == 0 && role == Qt::DisplayRole)
                ...
                return BTCturquoiseUnits::format(walletModel->getOptionsModel()->getDisplayUnit(), rec->recipient.amount, false, BTCturquoiseUnits::separatorNever);
            else
                return BTCturquoiseUnits::format(walletModel->getOptionsModel()->getDisplayUnit(), rec->recipient.amount);
        }
    }
...
{
    return (this->walletModel->getOptionsModel() != nullptr) ? tr("Requested") + " ("+BTCturquoiseUnits::name(this->walletModel->getOptionsModel()->getDisplayUnit()) + ")" : "";
}
