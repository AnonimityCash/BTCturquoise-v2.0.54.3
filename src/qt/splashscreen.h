...
#ifndef BTCTURQUOISE_QT_SPLASHSCREEN_H
#define BTCTURQUOISE_QT_SPLASHSCREEN_H
 ...
 *
 * @note this is intentionally not a QSplashScreen. BTCturquoise Core initialization
...
#endif // BTCTURQUOISE_QT_SPLASHSCREEN_H
