...
#ifndef BTCTURQUOISE_QT_BTCTURQUOISEGUI_H
#define BTCTURQUOISE_QT_BTCTURQUOISEGUI_H
...
/**
  BTCturquoise GUI main class. This class represents the main window of the BTCturquoise UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class BTCturquoiseGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit BTCturquoiseGUI(interfaces::Node& node, const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~BTCturquoiseGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a btcturquoise wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
private Q_SLOTS:
    ...
    /** Open external (default) editor with btcturquoise.conf */
    void showConfEditor();
...
#endif // BTCTURQUOISE_QT_BTCTURQUOISEGUI_H
