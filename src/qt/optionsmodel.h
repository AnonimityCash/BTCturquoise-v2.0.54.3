...
#ifndef BTCTURQUOISE_QT_OPTIONSMODEL_H
#define BTCTURQUOISE_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for BTCturquoise client.
...
public:
    ...
    enum OptionID {
        ...
        ProxyIPTor,             // QString
        ProxyPortTor,           // int
        DisplayUnit,            // BTCturquoiseUnits::Unit
...
#endif // BTCTURQUOISE_QT_OPTIONSMODEL_H
