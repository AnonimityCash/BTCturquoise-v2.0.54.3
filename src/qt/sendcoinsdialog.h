...
#ifndef BTCTURQUOISE_QT_SENDCOINSDIALOG_H
#define BTCTURQUOISE_QT_SENDCOINSDIALOG_H
...
/** Dialog for sending btcturquoises */
...
#endif // BTCTURQUOISE_QT_SENDCOINSDIALOG_H
