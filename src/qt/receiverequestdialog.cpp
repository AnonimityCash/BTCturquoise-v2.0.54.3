...
#include <config/btcturquoise-config.h> /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatBTCturquoiseURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + BTCturquoiseUnits::formatHtmlWithUnit(model->getOptionsModel()->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatBTCturquoiseURI(info));
}
