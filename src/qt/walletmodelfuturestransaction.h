...
#ifndef BTCTURQUOISE_QT_WALLETMODELFUTURESTRANSACTION_H
#define BTCTURQUOISE_QT_WALLETMODELFUTURESTRANSACTION_H
...
#endif // BTCTURQUOISE_QT_WALLETMODELFUTURESTRANSACTION_H
