...
#ifndef BTCTURQUOISE_QT_WALLETMODEL_H
#define BTCTURQUOISE_QT_WALLETMODEL_H
...
/** Interface to BTCturquoise wallet from Qt view code. */
...
#endif // BTCTURQUOISE_QT_WALLETMODEL_H
