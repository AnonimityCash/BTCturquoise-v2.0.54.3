...
#ifndef BTCTURQUOISE_QT_BTCTURQUOISEUNITS_H
#define BTCTURQUOISE_QT_BTCTURQUOISEUNITS_H
...
/** BTCturquoise unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class BTCturquoiseUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit BTCturquoiseUnits(QObject *parent);

    /** BTCturquoise units.
      @note Source: https://en.btcturquoise.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        BTCQ,
...
typedef BTCturquoiseUnits::Unit BTCturquoiseUnit;

#endif // BTCTURQUOISE_QT_BTCTURQUOISEUNITS_H
