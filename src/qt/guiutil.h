...
#ifndef BTCTURQUOISE_QT_GUIUTIL_H
#define BTCTURQUOISE_QT_GUIUTIL_H
...
/** Utility functions used by the BTCturquoise Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "btcturquoise:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load btcturquoise specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a btcturquoise specific theme is activated (light/dark).*/
...
#endif // BTCTURQUOISE_QT_GUIUTIL_H
