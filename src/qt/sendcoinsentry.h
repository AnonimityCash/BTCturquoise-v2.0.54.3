...
#ifndef BTCTURQUOISE_QT_SENDCOINSENTRY_H
#define BTCTURQUOISE_QT_SENDCOINSENTRY_H
...
/**
 * A single entry in the dialog for sending btcturquoises.
...
#endif // BTCTURQUOISE_QT_SENDCOINSENTRY_H
