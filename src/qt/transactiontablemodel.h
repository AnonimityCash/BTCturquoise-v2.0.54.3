...
#ifndef BTCTURQUOISE_QT_TRANSACTIONTABLEMODEL_H
#define BTCTURQUOISE_QT_TRANSACTIONTABLEMODEL_H
...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed=true, BTCturquoiseUnits::SeparatorStyle separators=BTCturquoiseUnits::separatorStandard) const;
...
#endif // BTCTURQUOISE_QT_TRANSACTIONTABLEMODEL_H
