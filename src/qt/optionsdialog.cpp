    ...
    pageButtons(0)
{
    ...
    ui->btcturquoiseAtStartup->setToolTip(ui->btcturquoiseAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->btcturquoiseAtStartup->setText(ui->btcturquoiseAtStartup->text().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new BTCturquoiseUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->btcturquoiseAtStartup, OptionsModel::StartAtStartup);
#ifndef Q_OS_MAC
