// Copyright (c) 2019 The BTCturquoise Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef BTCTURQUOISE_CRYPTO_CHACHA_POLY_AEAD_H
#define BTCTURQUOISE_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@btcturquoise.
 *
 ...
 *
 * The chacha20-poly1305@btcturquoise combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@btcturquoise cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@btcturquoise are relatively fast in
...
#endif // BTCTURQUOISE_CRYPTO_CHACHA_POLY_AEAD_H
