...
uint64_t GetRand(uint64_t nMax)
{
    ...
    // This will later conflict with btcturquoise#14955. Simply take the btcturquoise version as resolution and pass g_mock_deterministic_tests into FastRandomContext
