...
#ifndef BTCTURQUOISE_LLMQ_QUORUMS_DKGSESSIONHANDLER_H
#define BTCTURQUOISE_LLMQ_QUORUMS_DKGSESSIONHANDLER_H
...
#endif // BTCTURQUOISE_LLMQ_QUORUMS_DKGSESSIONHANDLER_H
