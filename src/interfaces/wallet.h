...
#ifndef BTCTURQUOISE_INTERFACES_WALLET_H
#define BTCTURQUOISE_INTERFACES_WALLET_H
...
namespace CoinJoin {
//! Interface for the wallet constrained src/coinjoin part of a btcturquoise node (btcturquoised process).
class Client
{
public:
    virtual ~Client() {}
...
#endif // BTCTURQUOISE_INTERFACES_WALLET_H
