...
#ifndef BTCTURQUOISE_INTERFACES_NODE_H
#define BTCTURQUOISE_INTERFACES_NODE_H
...
//! Interface for the src/evo part of a btcturquoise node (btcturquoised process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/llmq part of a btcturquoise node (btcturquoised process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a btcturquoise node (btcturquoised process).
namespace Smartnode
{
class Sync
{
...
//! Top-level interface for a btcturquoise node (btcturquoised process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // BTCTURQUOISE_INTERFACES_NODE_H
