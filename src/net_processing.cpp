...
// Copyright (c) 2009-2016 The BTCturquoise Core developers
 ...
 *  We have 4 times smaller block times in BTCturquoise, so we need to push 4 times more invs per 1MB. */
...
bool static AlreadyHave(const CInv& inv) EXCLUSIVE_LOCKS_REQUIRED(cs_main)
{
    ...
    /*
        BTCturquoise Related Inventory Messages
...
bool PeerLogicValidation::SendMessages(CNode* pto)
{
    const Consensus::Params& consensusParams = Params().GetConsensus();
    {
        ...
        if (!fReindex && !fImporting && !IsInitialBlockDownload())
        {
            ...
            // The proper solution would be to move this out of here, but this is not worth the effort right now as btcturquoise#15632 will later do this.
        ...
        // BTCturquoise this code also handles non-TXs (Dash specific messages)
