// Copyright (c) 2012-2015 The BTCturquoise Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef BTCTURQUOISE_LIMITEDMAP_H
#define BTCTURQUOISE_LIMITEDMAP_H
...
// WARNING, this was initially the "limitedmap" class from BTCturquoise, but now does not maintain ordering. If any backports
...
#endif // BTCTURQUOISE_LIMITEDMAP_H
