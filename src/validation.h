...
#ifndef BTCTURQUOISE_VALIDATION_H
#define BTCTURQUOISE_VALIDATION_H
...
static const int64_t DEFAULT_MAX_TIP_AGE = 6 * 60 * 60; // ~144 blocks behind -> 2 x fork detection time, was 24 * 60 * 60 in btcturquoise
...
#endif // BTCTURQUOISE_VALIDATION_H
