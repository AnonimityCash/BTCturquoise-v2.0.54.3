...
#ifndef BTCTURQUOISE_CHAINPARAMS_H
#define BTCTURQUOISE_CHAINPARAMS_H
 ...
 * BTCturquoise system. There are three: the main network on which people trade goods
...
#endif // BTCTURQUOISE_CHAINPARAMS_H
