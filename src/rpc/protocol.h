...
#ifndef BTCTURQUOISE_RPC_PROTOCOL_H
#define BTCTURQUOISE_RPC_PROTOCOL_H
...
//! BTCturquoise Core RPC error codes
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in btcturquoised
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< BTCturquoise is not connected
...
#endif // BTCTURQUOISE_RPC_PROTOCOL_H
