...
#ifndef BTCTURQUOISE_SCRIPT_SCRIPT_H
#define BTCTURQUOISE_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, BTCturquoise always counted CHECKMULTISIGs
...
#endif // BTCTURQUOISE_SCRIPT_SCRIPT_H
