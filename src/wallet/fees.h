...
// Copyright (c) 2009-2017 The BTCturquoise Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef BTCTURQUOISE_WALLET_FEES_H
#define BTCTURQUOISE_WALLET_FEES_H
...
#endif // BTCTURQUOISE_WALLET_FEES_H
