...
std::map<CTxDestination, std::vector<COutput>> CWallet::ListCoins() const
{
    ...
    // https://github.com/btcturquoise/btcturquoise/pull/10340, but that change has been
    // postponed until after https://github.com/btcturquoise/btcturquoise/pull/10244 to
...
bool CWallet::CreateTransaction(const std::vector<CRecipient>& vecSend, CTransactionRef& tx, CReserveKey& reservekey, CAmount& nFeeRet, int& nChangePosInOut, std::string& strFailReason, const CCoinControl& coin_control, bool sign, int nExtraPayloadSize, FuturePartialPayload* fpp)
{
    ...
    unsigned int nBytes;
    {
        ...
        LOCK(cs_wallet);
        {
            ...
            // change transaction isn't always pay-to-btcturquoise-address
            CScript scriptChange;
 ...
 * https://btcturquoisetalk.org/?topic=54527, or
 * https://github.com/btcturquoise/btcturquoise/pull/1393.
 */
