...
#ifndef BTCTURQUOISE_WALLET_WALLET_H
#define BTCTURQUOISE_WALLET_WALLET_H
...
public:
     ...
     * on this btcturquoise node, and set to 0 for transactions that were created
...
public:
    ...
    /// Get collateral BTCQ output and keys which can be used for the Smartnode
...
#endif // BTCTURQUOISE_WALLET_WALLET_H
