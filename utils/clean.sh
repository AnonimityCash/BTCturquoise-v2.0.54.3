...
rm -f src/config/btcturquoise-config.h
...
rm -rf test_btcturquoise.coverage/ btcturquoise-gtest.coverage/ total.coverage/
...
clean_exe src/bench/bench_btcturquoise
clean_exe src/btcturquoise-cli
clean_exe src/btcturquoised
clean_exe src/btcturquoise-gtest
clean_exe src/btcturquoise-tx
clean_exe src/test/test_btcturquoise
clean_exe src/test/test_btcturquoise_fuzzy
...
clean_dep . src/config/btcturquoise-config.h.in
