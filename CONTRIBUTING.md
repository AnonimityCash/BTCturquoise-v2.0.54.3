Contributing to BTCturquoise Core
============================

The BTCturquoise Core project operates an open contributor model where anyone is
...
the pull request affects. Valid areas as:
  ...
  - *Qt* for changes to btcturquoise-qt
...
[Translation Process](https://github.com/btcturquoiseverse/btcturquoise/blob/master/doc/translation_process.md) 
...
The following applies to code changes to the BTCturquoise Core project (and related
projects such as libsecp256k1), and is not to be confused with overall BTCturquoise
Network Protocol consensus changes.

Whether a pull request is merged into BTCturquoise Core rests with the project merge
...
Patches that change BTCturquoise consensus rules are considerably more involved than
...
Where a patch set proposes to change the BTCturquoise consensus, it must have been
...
The review process is normally fairly responsive on the BTCturquoise Core repository, however
...
The project leader is the release manager for each BTCturquoise Core release.
