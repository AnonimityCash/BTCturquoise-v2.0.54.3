...
class BIP66Test(BTCturquoiseTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # btcturquoised is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and btcturquoised produces more specific reject
            # reasons.
