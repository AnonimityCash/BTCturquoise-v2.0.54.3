...
class NodeNetworkLimitedTest(BTCturquoiseTestFramework):
    ...
    def run_test(self):
        ...
        assert_equal(node1.firstAddrnServices, 1028) # Not 1036 like btcturquoise, because NODE_WITNESS = 1 << 3 = 8
