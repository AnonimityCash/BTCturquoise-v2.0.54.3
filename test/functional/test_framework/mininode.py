...
# Copyright (c) 2010-2016 The BTCturquoise Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""BTCturquoise P2P network half-a-node.
...
class P2PInterface(P2PConnection):
    """A high-level P2P interface class for communicating with a BTCturquoise node.
    ...
    def wait_for_disconnect(self, timeout=60):
        ...
        # This is a hack. The related issues should be fixed by btcturquoise 14119 and 14457.
        time.sleep(1)
