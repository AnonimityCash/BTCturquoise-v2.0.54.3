...
# Copyright (c) 2010-2017 The BTCturquoise Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""BTCturquoise test framework primitive and message structures
CBlock, CTransaction, CBlockHeader, CTxIn, CTxOut, etc....:
    data structures that should map to corresponding structures in
    btcturquoise/primitives
...
# Objects that map to btcturquoised objects, which can be serialized/deserialized
...
class msg_headers():
    ...
    def deserialize(self, f):
        # comment in btcturquoised indicates these should be deserialized as blocks
