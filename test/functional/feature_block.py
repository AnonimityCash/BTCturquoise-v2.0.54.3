...
class FullBlockTest(BTCturquoiseTestFramework):
    ...
    def setup_nodes(self):
        ...
        # TODO remove this when btcturquoise#13837 gets backported and change it to use self.rpc_timeout
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure btcturquoised isn't accepting b26
        ...
        # Extend the b28 chain to make sure btcturquoised isn't accepting b28
        ...
        # btcturquoised doesn't disconnect us for sending a bloated block, but if we subsequently
        ...
        #    Low-S and High-S values (whereas the btcturquoise code has custom code which does so);
