...
class WalletTest(BTCturquoiseTestFramework):
    ...
    def run_test(self):
        ...
        # node0 should end up with 1000 BTCturquoise in block rewards plus fees, but
        ...
        # Send 100 BTCturquoise with subtract fee from amount
        ...
        maintenance = [
            ...
            '-zapwallettxes=1',
            '-zapwallettxes=2',
            # disabled until issue is fixed: https://github.com/btcturquoise/btcturquoise/issues/7463
            # '-salvagewallet',
        ]
        chainlimit = 6
