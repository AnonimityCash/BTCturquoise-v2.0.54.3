...
valid (https://github.com/btcturquoise/btcturquoise/pull/9484)
...
class AssumeValidTest(BTCturquoiseTestFramework):
    ...
    def run_test(self):
        ...
        # Bury the assumed valid block 8400 deep (BTCturquoise needs 4x as much blocks to allow -assumevalid to work)
        for i in range(8400):
            block = create_block(self.tip, create_coinbase(height), self.block_time)
            block.nVersion = 4
            block.solve()
