...
class RawTransactionsTest(BTCturquoiseTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-5, "Invalid BTCturquoise address", self.nodes[0].createrawtransaction, [], {'foo': 0})
        ...
        # Note, this is different to btcturquoise. BTCturquoise has a 32 bit integer
