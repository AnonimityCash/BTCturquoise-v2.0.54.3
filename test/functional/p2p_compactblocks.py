...
# TestP2PConn: A peer we use to send messages to btcturquoised, and store responses.
...
class CompactBlocksTest(BTCturquoiseTestFramework):
    ...
    # This test actually causes btcturquoised to (reasonably!) disconnect us, so do this last.
    ...
    # btcturquoised's choice of nonce.
    ...
    # Test that btcturquoised requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for btcturquoised to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # btcturquoised will not send blocktxn responses for blocks whose height is
